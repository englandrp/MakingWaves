...
namespace WindowsGame1
{
    ...
    public class KinectChooser : DrawableGameComponent
    {
        ...
        public KinectStatus LastStatus { get; private set; }
          ...
          float theCorrection = 0.3f;
          float thePrediction = 0.8f;
          ...
          //float theSmoothing = 0.5f;
          //float theCorrection = 0.1f;
          //float thePrediction = 0.5f;
          //float theJitterRadius = 0.1f;
          //float theMaxDeviationRadius = 0.1f;
        ...
        protected override void LoadContent()
        {
            ...
            this.chooserBackground = Game.Content.Load<Texture2D>("Graphics/ChooserBackground");
           this.font = Game.Content.Load<SpriteFont>("gamefont");
            using (FileStream stream = new FileStream("pngtext" + "_" + ".png", FileMode.Create))
            {
                chooserBackground.SaveAsPng(stream, chooserBackground.Width, chooserBackground.Height);
                // screenShot.Dispose();
            }
        }
        ...
        public void updateValues()
        {
            ...
            if (this.Sensor != null)
            {
                TransformSmoothParameters theparam = new TransformSmoothParameters()
                {
                    Smoothing = theSmoothing,
                    Correction = theCorrection,
                    Prediction = thePrediction,
                    JitterRadius = theJitterRadius,
                    MaxDeviationRadius = theMaxDeviationRadius
                };
                this.Sensor.SkeletonStream.Enable(theparam);
            }
        }
