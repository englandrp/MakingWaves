...
namespace WindowsGame1
{
    ...
    /// </summary>
    class GameplayScreenCards : GameScreen
    {
        #region Fields
        bool wasActive;
        float pauseAlpha;
        ...
        /// Constructor.
        /// </summary>
        public GameplayScreenCards(Player theCurrentPlayer, SignPack theSignPack )
        {
            this.theSignPack = theSignPack;
        ...
        public override void LoadContent()
        {
         ...
         //   Thread.Sleep(1000);
            ...
            spriteFont = screenManager.game1.Content.Load<SpriteFont>("Arial");
            world = new WorldCards(screenManager.game1, theCurrentPlayer,  theSignPack);
            world.LoadContent();
        }
